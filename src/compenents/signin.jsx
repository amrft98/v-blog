...
<form onSubmit={logInSubmit} class="Form">
 ...
 <span> <a className="a-forget" href="/forget-password">{anothermessage}</a></span>
...
c0.001-0.001,0.002-0.001,0.003-0.002l6.19,5.238C36.971,39.205,44,34,44,24C44,22.659,43.862,21.35,43.611,20.083z"></path>
    ...
    <a className="google-button" href="http://localhost:8000/auth/google">Log in with Google</a>
  </div>
</div>
</div>
}

...
app.get("/auth/google/home",
  passport.authenticate("google", {
    ...
    res.cookie("jwt",token,{secure:true,sameSite:"none",httpOnly:true})
console.log(`the req cookie in index.js${req.cookies.jwt}`);
res.redirect("https://v-blog-react.onrender.com/home");
